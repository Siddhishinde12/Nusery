    ...
    return (
      ...
      >
        ...
        <div
          data-sidebar="sidebar"
          className={cn(
            "duration-200 fixed inset-y-0 z-10 flex h-svh transition-[left,right,width] ease-in-out",
            "w-[--sidebar-width]",
            "group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
            side === "left"
              ? "left-0 group-data-[collapsible=offcanvas]:-left-[--sidebar-width]"
              : "right-0 group-data-[collapsible=offcanvas]:-right-[--sidebar-width]",
            "flex-col bg-sidebar group-data-[side=left]:border-r group-data-[side=right]:border-l"
          )}
        >
          {children}
        </div>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-8 w-8 text-sidebar-foreground hover:text-sidebar-accent-foreground hover:bg-sidebar-accent", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
